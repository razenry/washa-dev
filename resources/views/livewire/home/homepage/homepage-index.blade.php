    ...
    <section class="bg-gray-900 min-h-screen mt-16">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            ...
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl text-white">No
                ...
                <span class="text-green-500 md:text-black md:px-1 md:rounded-2xl md:bg-green-500">Covered!</span>
            </h1>
    ...
    <section class="bg-gray-900 md:min-h-screen my-10" data-aos="fade-up" data-aos-duration="500">
        <div class="py-4 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold leading-tight text-white">
                    Our Services</h2>
                <p class="mb-6 font-light text-gray-400 md:text-lg">
                    We provide professional laundry services that guarantee a fresh, clean, and fast turnaround for your
                    clothes.
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-2 px-4 mx-auto max-w-screen-xl sm:py-4 lg:px-6">
            ...
            @foreach ($categories as $category)
                <div
                    class="w-full max-w-sm bg-gray-800 border border-gray-700 rounded-2xl shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105 mb-5">
                    <a href="#" class="block">
                        <img class="p-6 rounded-t-lg w-full h-[350px]  bg-gray-900"
                            src="{{ asset('storage/' . $category->photo) }}" alt="{{ $category->name }}">
                    </a>
                    <div class="px-6 mt-3 pb-6">
                        <a href="#" class="block mb-2">
                            <h5 class="text-2xl font-semibold tracking-tight text-white line-clamp-1">{{ $category->name }}
                            </h5>
                        </a>
                        <div class="flex items-center mt-3 mb-4">
                            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                                <span
                                    class="text-xl font-bold text-white">{{ number_format($category->price, 0, ',', '.') }}
                                    IDR</span>
                            </div>
                            <span
                                class="ms-3 inline-flex items-center text-sm font-semibold px-3 py-1 rounded-lg bg-blue-200 text-blue-800">
                                /
                                {{ $category->type == 1 ? 'Unit' : 'Kg' }}
                            </span>
                        </div>
                        <div class="flex items-center justify-start">
                            <a href="#"
                                class="flex items-center justify-center w-full py-3 text-lg font-medium text-white transition-all duration-300 bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-800">
                                <svg class="w-5 h-5 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                    fill="currentColor">
                                    <path fill-rule="evenodd"
                                        d="M10 2a8 8 0 017.75 10.75l-1.5-1.5A6 6 0 1016 10a6.02 6.02 0 00-1.5-4L10 2zM7.5 12.5a4.5 4.5 0 119 0h-2a2.5 2.5 0 10-5 0H7.5z"
                                        clip-rule="evenodd"></path>
                                </svg>
                                Book now
                            </a>
            ...
            <div id="accordion-collapse" data-accordion="collapse">
                ...
                <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
                    <div class="p-5 border border-b-0 border-gray-700">
                        <p class="text-gray-400">Washa currently provides laundry services in several areas. You can
                            check if we cover your location by visiting our service areas page or contacting our
                ...
                <div id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
                    <div class="p-5 border border-b-0 border-gray-700">
                        <p class="text-gray-400">The completion time for your laundry order depends on the type of
                            service you choose. Typically, our regular laundry service takes 1-2 days, while express
                            services are completed within a few hours.</p>
                    </div>
                </div>
                ...
                <div id="accordion-collapse-body-3" class="hidden" aria-labelledby="accordion-collapse-heading-3">
                    <div class="p-5 border border-b-0 border-gray-700">
                        <p class="text-gray-400">We accept various payment methods including credit/debit cards, mobile
                            payments (like Gopay and OVO), and cash payments upon delivery of services. For more
                            details, check our payment methods page.</p>
                    </div>
                </div>
            </div>

<div class="">
    ...
    <p class="text-gray-500 dark:text-gray-400">Welcome to the Users Management ✨</p>
            ...
            <table class="w-full text-sm text-left border border-gray-300 dark:border-gray-700">
                <thead class="bg-gray-100 dark:bg-gray-800 dark:text-white">
                    <tr>
                        ...
                        <th class="px-6 py-3 cursor-pointer hidden sm:table-cell">Role</th>
                ...
                <tbody>
                    @forelse ($users as $user)
                        <tr class="border-b border-gray-300 dark:border-gray-700 dark:text-white">
                            ...
                            <td class="px-6 py-4 hidden sm:table-cell">{{ $user->role }}</td>
                            <td class="px-6 py-4 hidden sm:table-cell">
                                <button wire:click="toggleStatus({{ $user->id }})"
                                    class="px-3 py-1 rounded text-white focus:outline-none {{ $user->status === '1' ? 'bg-green-500 hover:bg-green-600' : 'bg-red-500 hover:bg-red-600' }}">
                            ...
                            <td class="px-6 py-4 flex gap-3 justify-center items-center mt-4">
                                ...
                                <button class="text-red-600 dark:text-red-400" onclick="confirmDelete({{ $user->id }})">

<div>
    ...
    <form wire:submit.prevent="update">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="mb-5">
                <label for="password_confirm" class="block text-sm font-medium text-gray-900 dark:text-white">Confirm
                    Password</label>
        ...
        <button type="submit" wire:target="update"
            ...
            <span wire:loading wire:target="update" class="hidden">Processing...</span>
        </button>
    </form>
</div>

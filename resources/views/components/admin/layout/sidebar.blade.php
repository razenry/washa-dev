                            ...
                            <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
                                <li>
                                    <a href="{{ route('admin.dashboard.report.financial') }}"
                                        class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Financial</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin.dashboard.report.job') }}"
                                        class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Job</a>
                                </li>
                            </ul>
                        </li>
                    @else
                        ...
                        <li>
                            <a href="{{ route('transaction.index') }}"
                                ...
                                <span class="ml-3" sidebar-toggle-item>
                                    Transaction <span class="text-blue-700">{{ $transactionCount ? "($transactionCount)" : '' }}</span>
                                </span>
                            </a>
                        </li>
                    @endif
